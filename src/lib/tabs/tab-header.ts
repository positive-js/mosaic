...
@Component({
  ...
  host: {
    class: 'mc-tab-header',
    '[class.mc-tab-header-pagination-controls-enabled]': '_showPaginationControls',
    '[class.mc-tab-header-rtl]': '_getLayoutDirection() == \'rtl\''
  }
})
export class McTabHeader extends McTabHeaderBase
  ...
  set selectedIndex(value: number) {
    ...
    this._selectedIndexChanged = this._selectedIndex !== coercedValue;
    this._selectedIndex = coercedValue;

    if (this._keyManager) {
      this._keyManager.updateActiveItem(coercedValue);
    }
  }
  ...
  @ContentChildren(McTabLabelWrapper) _labelWrappers: QueryList<McTabLabelWrapper>;
  ...
  private _keyManager: FocusKeyManager<McTabLabelWrapper>;
