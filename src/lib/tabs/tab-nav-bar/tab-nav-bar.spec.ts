...
describe('McTabNavBar', () => {
  ...
  describe('basic behavior', () => {
    ...
    it('should add the active class if active', () => {
      ...
      fixture.detectChanges();
      expect(tabLinkElements[0].classList.contains('mc-tab-label-active')).toBeTruthy();
      expect(tabLinkElements[1].classList.contains('mc-tab-label-active')).toBeFalsy();

      tabLink2.nativeElement.click();
      fixture.detectChanges();
      expect(tabLinkElements[0].classList.contains('mc-tab-label-active')).toBeFalsy();
      expect(tabLinkElements[1].classList.contains('mc-tab-label-active')).toBeTruthy();
    });
    ...
    it('should add the disabled class if disabled', () => {
      ...
      expect(tabLinkElements.every((tabLinkEl) => !tabLinkEl.classList.contains('mc-tab-disabled')))
  ...
  it('should support the native tabindex attribute', () => {
    ...
    const tabLink = fixture.debugElement.query(By.directive(McTabLink))
...
class SimpleTabNavBarTestApp {
  @ViewChild(McTabNav) tabNavBar: McTabNav;
