...
describe('McButtonToggle with forms', () => {
  ...
  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [McButtonToggleModule, FormsModule, ReactiveFormsModule],
      declarations: [
...
describe('McButtonToggle without forms', () => {
  ...
  describe('with initial value and change event', () => {
    ...
    it('should not fire an initial change event', () => {
      ...
      let groupDebugElement = fixture.debugElement.query(By.directive(McButtonToggleGroup));
      let groupInstance: McButtonToggleGroup = groupDebugElement.injector
  ...
  describe('aria-label handling ', () => {
    it('should not set the aria-label attribute if none is provided', () => {
      ...
      let checkboxDebugElement = fixture.debugElement.query(By.directive(McButtonToggle));
  ...
  describe('with provided aria-labelledby ', () => {
    ...
    it('should use the provided aria-labelledby', () => {
      ...
      checkboxDebugElement = fixture.debugElement.query(By.directive(McButtonToggle));
