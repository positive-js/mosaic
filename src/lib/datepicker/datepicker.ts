...
export const MC_DATEPICKER_SCROLL_STRATEGY =
    new InjectionToken<() => IScrollStrategy>('mat-datepicker-scroll-strategy');

/** @docs-private */
// tslint:disable-next-line:naming-convention
export function MAT_DATEPICKER_SCROLL_STRATEGY_FACTORY(overlay: Overlay): () => IScrollStrategy {
...
// tslint:disable-next-line:naming-convention
export const MatDatepickerContentMixinBase: CanColorCtor & typeof MatDatepickerContentBase =
...
export class McDatepickerContent<D> extends MatDatepickerContentMixinBase
