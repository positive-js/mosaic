...
export class McCalendar<D> implements AfterContentInit, AfterViewChecked, OnDestroy, OnChanges {
  ...
  set selected(value: D | null) {
    this._selected = this.getValidDateOrNull(this._dateAdapter.deserialize(value));
  }
  ...
  set minDate(value: D | null) {
    this._minDate = this.getValidDateOrNull(this._dateAdapter.deserialize(value));
  }
  ...
  set maxDate(value: D | null) {
    this._maxDate = this.getValidDateOrNull(this._dateAdapter.deserialize(value));
  }
  ...
  set activeDate(value: D) {
    this.clampedActiveDate = this._dateAdapter.clampDate(value, this.minDate, this.maxDate);
    this.stateChanges.next();
  }

  /** Whether the calendar is in month view. */
  get currentView(): McCalendarView { return this._currentView; }
  ...
  constructor(intl: McDatepickerIntl,
