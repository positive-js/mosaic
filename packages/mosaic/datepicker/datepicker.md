...
В разных странах приняты разные традиции записи даты: дд.мм.гггг в России, дд/мм/гггг в Англии или дд-мм-гггш в Германии. Дейтпикер учитывает особенности страны и правильно форматирует значение. Ожидаемый формат даты выводится как плейсхолдер.
...
| <span class="hot-key-Button">Shift</span> + <span class="hot-key-Button">Tab</span>    | Перевести фокус на поле с датой |
...
Размер виджета — w:292px; h:248px 
