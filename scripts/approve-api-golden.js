...
const packageNameGuess = guessPackageName(searchPackageName, path.join(projectDir, 'packages'));
...
shelljs.exec(`yarn bazel run ${ apiGoldenTargetName } --verbose_failures`);
